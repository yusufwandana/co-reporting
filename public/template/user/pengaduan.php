              ...
              <div class="col-lg">
                <div class="p-5">
                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <small>NIK</small>
                      <input type="file" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" readonly="readonly" value="<?= $data['nik'];?>" placeholder="NIK">
                    </div>
                    <hr/>
                    <div class="form-group">
                    ...
                    <input type="submit" onclick="return confirm('Kirim Pengaduan ini ?');" name="pengaduan" value="Kirim" class="btn btn-success btn-user btn-block">
                  </form>
                  <hr>
                </div>
              </div>
