              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h2 class="h4 text-gray-900 mb-4">Pengaduan ditulis pada Tanggal <span class="text-info">{{$data->tanggal}}</span> </h2>
                  </div>
                  <form method="POST" action="{{route('post.tanggapan')}}">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control form-control-user" rows="5" placeholder="Berikan tanggapan Anda.." name="teks_tanggapan"></textarea>
                    </div><hr/>
                    <button onclick="return confirm('Jika Anda memberi tanggapan, status pengaduan akan berubah jadi diproses. Yakin?');" class="btn btn-primary btn-user btn-block">Beri tanggapan</button>
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{URL::previous()}}">Kembali</a>
                  </div>
                </div>
              </div>
            </div>
