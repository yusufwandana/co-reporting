...
<body id="page-top">
  ...
  <!-- Page level plugins -->
  <script src="{{asset('template/user/vendor/chart.js/Chart.min.js')}}"></script>

  <!-- Page level custom scripts -->
  <script src="{{asset('template/user/js/demo/chart-area-demo.js')}}"></script>
  <script src="{{asset('template/user/js/demo/chart-pie-demo.js')}}"></script>
