...
<head>
  ...
  <title>{{ucwords(auth()->user()->role)}} | Dashboard</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard {{ucwords(auth()->user()->role)}}</h1>
          </div>
          <!-- Content Row -->
          <div class="row">
  ...
  <!-- Page level plugins -->
  <script src="{{asset('public/template/user/vendor/chart.js/Chart.min.js')}}"></script>

  <!-- Page level custom scripts -->
  <script src="{{asset('public/template/user/js/demo/chart-area-demo.js')}}"></script>
  <script src="{{asset('public/template/user/js/demo/chart-pie-demo.js')}}"></script>
